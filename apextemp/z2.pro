...
pro z2, scanno, year, month, date, n_nod_pos

fileroot = 'APEX-'+$                                   
  string(scanno,year,month,date,format='(I5,"-",I4,"-",I02,"-",I02)')+$
         '-E-086.A-0793A-2010'
...
save,vopt_spectra,nod_struct,vopt,file=savfile
