...
;	DMS, August, 1998.
;       SG 2004/02/02 The loop variable in the last section was not 
;          of LONG type, which caused crashing when called by 
;          GETWIENER.PRO because the loop limit was too large.
;-
...
vol = 0.0
for i=0L, n_elements(tr)/3-1 do begin ;Sum each triangle
    t = tr[*,i]
