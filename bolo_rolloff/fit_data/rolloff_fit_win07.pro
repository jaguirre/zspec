...
;dates=[426,502,506,507,508,509,511,512,513,514,515,516]
dates=[116,117,118,119,120,121,122,123,124,125,130,213,214,215]

;dates=[116,117,118,119,120]
...
SAVE, FILENAME = !ZSPEC_PIPELINE_ROOT + $
      ...
      PATH_SEP() + 'rolloff_fits_2007_1116_1215_10mV_71Hz.sav'
