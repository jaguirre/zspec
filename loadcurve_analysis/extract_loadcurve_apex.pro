...
pro extract_loadcurve_apex, logfile
...
; Read through the boxes to figure out how many time samples we have
n = lonarr(10)
...
; 20 seconds for the current batch of loadcurves, but this should be safe.
t0 = 12.
