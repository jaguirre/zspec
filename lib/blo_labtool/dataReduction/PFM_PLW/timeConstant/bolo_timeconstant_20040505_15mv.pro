;========================================================================
; NAME		: bolo_timeconstant_20040505_15mv
;
...
PRO  bolo_timeconstant_20040505_15mv
    ...
    ;find the good pixel labels and the number of good pixels
     ...
     !p.multi=0
     psterm, file=path+'bolo_timeconst_20040505_15mV.ps'
