pro bolo_plot_optperfhist_all_20031007

path = '/data1/SPIRE_PFM_SLW/20031007/SvsBias/'

readfmt, path+'blo_optperf_all_20031007.txt', 'A13,f14,f13', pixname, pmax, pfit, skip=5
...
psterm, file=path+'blo_optperfhist_all_20031007.ps'
end
