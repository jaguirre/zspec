pro bolo_optimum_bias_20040505

  ;input  path
  path = '/data1/SPIRE_PFM_PLW/20040505/SvsBias/'
 
  ;Frequency file name
  ;20040505_opt_frequ.txt is prepared by looking at the spectrum by blo_labtool
  ...
  blo_opt_bias_performance, logfname, pixeln, optBias, fitPeakBias,path=path, $
  	/plot, fintvl=[0.010,0.030]
  !p.multi=0
  psterm, file=path+'blo_optperf_20040505.ps'

  openw, un,  path+'blo_optperf_20040505.txt', /get_lun
