;==================================================================
;  
; NAME		:  bolo_rstar_tstar_20031208
;   
...
PRO bolo_rstar_tstar_20031208
     ...
     !p.multi=0
     psterm, file=path+'lnRT20031208.ps'
     
 
     openw, un, path+'bolo_rstar_tstar_20031208.txt', /get_lun
