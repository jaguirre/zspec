;=========================================================
; NAME		:  bolo_plot_tc_hist_20040926_30mv
;   
...
pro bolo_plot_tc_hist_20040926_30mv

path = '/data1/SPIRE_PFM_PMW2/20040926/30mV/'


readfmt, path+'timeconst_20040926_30mV.txt', 'a12,f10,f10', pixel, tau, stau, skip=4
tau = tau*1000. ;msec
...
psterm, file=path+'bolo_plot_tc_hist_20040926_30mV.ps'
