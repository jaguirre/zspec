;========================================================================
; NAME		: bolo_timeconstant_20040926_10mm
;
...
PRO  bolo_timeconstant_20040926_10mv
    ...
    ;find the good pixel labels and the number of good pixels
     ...
     openw, un,  path+'timeconst_20040926_10mV.txt',/get_lun
     printf, un, systime()
     printf, un
     ...
     !p.multi=0
     psterm, file=path+'bolo_timeconst_20040926_10mV.ps'
