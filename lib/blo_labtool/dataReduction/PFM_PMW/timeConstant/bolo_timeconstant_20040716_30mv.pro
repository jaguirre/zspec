;========================================================================
; NAME		: bolo_timeconstant_20040716_30mv
;
...
PRO  bolo_timeconstant_20040716_30mv
    ...
    ;find the good pixel labels and the number of good pixels
     ...
     !p.multi=0
     psterm, file=path+'bolo_timeconst_20040716_30mV.ps'
