...
;
; 2003/07/16 B. Schulz
; 2003/07/16 L. Zhang (changed to 03/07/16)
;=============================================================
...
openw, un, path+'timeconst_20030716.txt',/get_lun
printf, un, systime()
printf, un
...
!p.multi=0
psterm, file=path+'blo_timeconst_20030716.ps'
