;==================================================================
; NAME          : bolo_g0_beta_200307221320.pro
;   
...
;==================================================================
 ...
 pro bolo_g0_beta_200307221320, Tbath=Tbath
     
     
      path='/data1/SPIRE_CQM/20030722b/'			       
      path2='/data1/SPIRE_CQM/20030718/'

     
     ;Rstore the Rstar and Tstar from a file
     bolo_restore_rstar_tstar, Rstar, Tstar, path=path2, $
     ...
     restore, path+'loadcrv_200307221320.sav'
