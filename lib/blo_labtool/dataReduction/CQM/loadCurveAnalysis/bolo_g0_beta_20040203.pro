;==================================================================
; NAME          : bolo_g0_beta_20040203.pro
;   
; DESCRIPTION	:  Calculate G0 and Beta
; 
; 2003/12/16    :  L. Zhang
; 
...
;               problem if xx structure and Rstar elements not same number!!!!
; 2004/04/12    L. Zhang, using the 2003/07/18's Rload.txt and Rstar
;               and Tstar to test the fits file downloaded from QLA 
;                
;==================================================================
 
 pro bolo_g0_beta_20040203
     ...
     bolo_restore_rstar_tstar, Rstar, Tstar, path=path, $
             filename='bolo_rstar_tstar_20030718.txt'
     ...
     restore, path+'loadcrv_20040203.sav'
