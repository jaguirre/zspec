;========================================================================
; NAME		:  bolo_timeconstant_20031007_25mv
;
...
PRO  bolo_timeconstant_20031007_25mv
    ...
    ;find the good pixel labels and the nubmer of good pixels
     ...
     !p.multi=0
     psterm, file=path+'bolo_timeconst_20031007_25mV.ps'
