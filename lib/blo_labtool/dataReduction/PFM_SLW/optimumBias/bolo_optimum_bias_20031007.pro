pro bolo_optimum_bias_20031007
  ...
  logfname = path + '20031007_opt_frequ.txt'
  ...
  !p.multi=0
  psterm, file=path+'blo_optperf_20031007.ps'

  openw, un,  path+'blo_optperf_20031007.txt', /get_lun
