; $Id: exptv.pro,v 1.1 2003/11/14 20:16:56 stoverp Exp $
; $Log: exptv.pro,v $
...
;
	PRO EXPTV,ARRAY,NOSQUARE=NOSQUARE,SMOOTH=SMOOTH,NOBOX=NOBOX,	$
		...
		SCALE=SCALE,DATA=DATA,ADJUST=ADJUST
;+
; Project     : SOHO - CDS
;
; Name        : 
...
;
	SCALE_TV,ARRAY,MX,MY,JX,JY,NOSQUARE=NOSQUARE,SIZE=SIZE,NOBOX=NOBOX, $
		...
		RELATIVE=RELATIVE,SCALE=SCALE,ADJUST=ADJUST
;
