; $Id: get_im_keyword.pro,v 1.1 2003/11/14 20:59:07 stoverp Exp $
; $Log: get_im_keyword.pro,v $
; Revision 1.1  2003/11/14 20:59:07  stoverp
; Initial import -- SolarSoft library function
;
