	PRO CONTV,ARRAY,MX,MY,JX,JY,LEVELS=LEVELS,COLORS=COLORS,$
                  DISABLE=DISABLE,MAX_VALUE=MAX_VALUE,THICK=THICK,$
                  ORIGIN=ORIGIN,SCALE=SCALE,NLEVELS=NLEVELS
;+
; Project     : SOHO - CDS
;
; Name        : 
...
;
	...
	IF N_ELEMENTS(COLORS)  NE 0 THEN COMMAND = COMMAND + ",C_COLORS=COLORS"
	...
	IF N_ELEMENTS(NLEVELS)  NE 0 THEN COMMAND = COMMAND + ",NLEVELS=NLEVELS"       
